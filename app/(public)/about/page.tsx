...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <PlaceholderBanner
        label="Placeholder copy — pending review"
        body="The text on this page is a working draft for Sam to review and adapt. It has not been finalised."
      />
      ...
      <div className="prose prose-lg max-w-none text-body-grey leading-relaxed space-y-6">
        <p className="text-xl">
          ...
          exclusively for controlled laboratory research, accompanied by a
          Certificate of Analysis, and backed by a transparent approach to
        ...
        <p>
          Every batch we receive is independently tested by high-performance
          liquid chromatography (HPLC) before being listed for sale. HPLC
          separates the compounds in a sample so that purity can be measured
          against a known reference. Our Certificates of Analysis report the
          HPLC trace, the measured purity percentage, and the batch identifier
          so that each order can be traced back to the specific test that was
          performed on the material supplied.
        </p>

        <h2 className="text-3xl mt-12">Our commitment to research use</h2>
        <p>
          We do not sell products for human or veterinary consumption, and we
          do not provide dosage guidance, therapeutic claims, or application
          advice. Our customers are researchers and laboratory professionals;
          our role is to supply them with documented research-grade compounds
          and the paperwork that accompanies them. Every order placed on this
          site must be confirmed as intended for laboratory research use before
          it is accepted.
        </p>

        <h2 className="text-3xl mt-12">Why documentation matters</h2>
        <p>
          In research, the compound is only as good as the documentation that
          accompanies it. A Certificate of Analysis is a standard piece of
