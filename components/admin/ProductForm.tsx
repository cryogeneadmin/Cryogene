    ...
    <form onSubmit={handleSubmit} className="space-y-10 max-w-4xl">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full border border-border p-2 mono"
            />
          </div>
          <div>
        ...
        <div className="mt-6">
          ...
          <textarea
            ...
            rows={8}
            className="w-full border border-border p-2 font-mono text-sm"
          />
        </div>
      </section>
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          <h2 className="font-serif text-2xl text-navy">Variants</h2>
          <button
            type="button"
            onClick={addVariant}
        ...
        <div className="space-y-4">
          {draft.variants.map((v, idx) => (
            <div
              key={v._key}
              className="bg-white border border-border p-4 grid grid-cols-1 md:grid-cols-[1fr_1fr_1fr_1fr_1fr_auto_auto] gap-3 items-end"
            >
              <div>
                ...
                <input
                  ...
                  className="w-full border border-border p-2 mono text-xs"
                />
              </div>
              <div>
      ...
      <div className="flex gap-3 sticky bottom-0 bg-offwhite py-4 border-t border-border">
        <button
          type="submit"
          disabled={saving}
        ...
        <a
          href="/admin/products"
          className="px-6 py-3 border border-border uppercase tracking-wider text-xs hover:bg-white"
        >
          Cancel
        </a>
      </div>
